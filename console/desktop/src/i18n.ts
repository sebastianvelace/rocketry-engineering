...
const copy = {
  en: {
    ...
    newAgentResult: "New result from agent",
    ...
    send: "Send",
    guideTurn: "Guide turn",
    guidePlaceholder: "Add guidance to the active Codex turn...",
    stop: "Stop",
    approve: "Allow once",
  ...
  es: {
    ...
    newAgentResult: "Nuevo resultado del agente",
    ...
    send: "Enviar",
    guideTurn: "Guiar turno",
    guidePlaceholder: "Añade una indicación al turno activo de Codex...",
    stop: "Detener",
    ...
    deleteCurrentConversation: "Borrar conversación actual",
